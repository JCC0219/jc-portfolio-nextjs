...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto min-h-[100svh] flex flex-col items-center justify-center gap-4 pt-24 pb-10 md:pt-16 md:pb-0">
      <motion.div
